...
**Links:** GitHub: [github.com/edycutjong/wardix](https://github.com/edycutjong/wardix) · Live console: [wardix.edycu.dev](https://wardix.edycu.dev) · Video: *(record + paste real URL)* · Real demo: `npm run demo:real` · Tests: **154 (Vitest)**.
