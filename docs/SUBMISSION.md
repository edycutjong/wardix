...
**Links:** GitHub: [github.com/edycutjong/dorahacks-t3adk-wardix](https://github.com/edycutjong/dorahacks-t3adk-wardix) · Live: [wardix.vercel.app](https://wardix.vercel.app) · Video: [youtu.be/wardix-demo-adk](https://youtu.be/wardix-demo-adk) · Tests: **114 (Vitest)** · `scripts/bench.py` p50/p95 included.
